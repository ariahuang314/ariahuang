...
from .plot_functions import create_gauge,determine_esg_level,create_doughnut_chart,create_doughnut_chart_s,create_doughnut_chart_g,create_bar_chart,generate_summary_investors,generate_summary_management,generate_summary_regulators
from dash import Dash, dcc, html, Input, Output
fig_gauge=create_gauge()
esg_level=determine_esg_level()
fig_doughnut_chart_e=create_doughnut_chart()
fig_doughnut_chart_s=create_doughnut_chart_s()
fig_doughnut_chart_g=create_doughnut_chart_g()
fig_bar_chart=create_bar_chart()
investor_summary = generate_summary_investors()
management_summary=generate_summary_management()
regulators_summary=generate_summary_regulators()
...
def summary_regulators_layout():
    return html.Div([
        ...
        dcc.Textarea(
            id='regulators_summary',
            value=regulators_summary,
            style={
                'width': '95%',
                'height': '1000px',
                'margin': 'auto',
